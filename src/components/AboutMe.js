...
const AboutMe = () => {
  return (
    <AboutMeContainer>
      <AboutMeBox>
        <AboutMeParagraph>Hello World and people in it, I’m Viktor. A computer-loving gamer turned adult, turned store manager, turned sales support and product planner,
