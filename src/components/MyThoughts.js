...
import { OuterWrapper, SectionHeader, Wrapper, FeaturedProjectWrapper, ProjectCard, ThumbnailWrapper, ProjectInfoHeader, ProjectInfo, SubParagraphArrows } from './GlobalStyleComponents';
import Lightbulb from './images/Lightbulb.jpg'
import Drumroll from './images/Drumroll.jpg'

/* Component that that prints 2 articels side by side, and will adjust to one above one below if its a small screen */

const MyThoughts = ({ color, colorSecond }) => {
  return (
    <OuterWrapper>
      <Wrapper>
