      ...
      <div className="container contact_container">
        <div className="contact__options p-9">
          <article className="contact__option">
            ...
            <h4>Email</h4>
            <a href="mailto:so.mariagloria@gmail.com" target="_blank" rel="noreferrer">Send a message</a>
          </article>
          <article className="contact__option">
          ...
          <article className="contact__option">
            ...
            <h4>Messenger</h4>
            <a href="https://m.me/mariamustonenso" target="_blank" rel="noreferrer">Send a message</a>
          </article>
        </div>
        {/* End of contact */}
