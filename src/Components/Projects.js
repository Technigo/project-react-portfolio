...
const Projects = () => {
  ...
  const filteredProjects = projects.filter((project) => (project.name.includes('todo')) || (project.name.includes('movies')) || (project.name.includes('survey')) || (project.name.includes('music')))
